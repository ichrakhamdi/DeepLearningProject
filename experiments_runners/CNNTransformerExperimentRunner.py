...
class CNNTransformerExperimentRunner(BaseExperimentRunner):
    ...
    def _run_single_experiment(self, class_type, aug, cw):
        ...
        try:
            ...
            print(f"[Preprocessing Train] Shape after scaling/encoding (aug={aug}): X={X_train.shape}, y={y_train.shape}")
            ...
            # Create sequences for CNN+Transformer
